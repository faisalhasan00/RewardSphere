      ...
      <nav className="h-[56px] bg-white/90 backdrop-blur-[12px] flex items-center px-4 sm:px-6 lg:px-8 border-none">
        <div className="container mx-auto flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3 sm:gap-5">
             ...
             {/* Wallet Pill - Smaller on Mobile */}
             <Link href="/dashboard/wallet">
               <div className="flex items-center gap-1.5 sm:gap-2 bg-[#E6F8EF] text-[#007A52] px-3 py-1 sm:px-3.5 sm:py-1 rounded-full font-black text-[12px] sm:text-[13px] border border-[#007A52]/10 active:scale-95 transition-all shadow-sm shadow-[#007A52]/5">
